...
class _CarouselPageViewState extends State<CarouselPageView> {
  ...
  Widget build(BuildContext context) {
    final double height = 26.h; // cap carousel height to avoid overflow on small screens
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return AnimatedPadding(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: isActive ? 4 : 10, vertical: isActive ? 0 : 6),
                    child: AnimatedScale(
